...
import ProvidersPhoneNumberCRUDFormComponent from './ProvidersPhoneNumberCRUDForm.Component'

class ProvidersPhoneNumberCRUDFormComposition extends Component {
    ...
    render() {
        ...
        return(
            <ProvidersPhoneNumberCRUDFormComponent
                {...this.props}
...
export default WithKeyboardAnimationHOC(FormikWrapper(ProvidersPhoneNumberCRUDFormComposition))
