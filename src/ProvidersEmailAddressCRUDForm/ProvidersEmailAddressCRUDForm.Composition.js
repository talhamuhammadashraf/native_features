...
import ProvidersEmailAddressCRUDFormComponent from './ProvidersEmailAddressCRUDForm.Component'

class ProvidersEmailAddressCRUDFormComposition extends Component {
    ...
    render() {
        ...
        return(
            <ProvidersEmailAddressCRUDFormComponent
                {...this.props}
...
export default WithKeyboardAnimationHOC(FormikWrapper(ProvidersEmailAddressCRUDFormComposition))
