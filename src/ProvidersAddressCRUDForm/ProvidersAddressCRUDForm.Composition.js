...
import ProvidersAddressCRUDFormComponent from './ProvidersAddressCRUDForm.Component'

class ProvidersAddressCRUDFormComposition extends Component {
    ...
    render() {
        ...
        return(
            <ProvidersAddressCRUDFormComponent
                {...this.props}
...
export default WithKeyboardAnimationHOC(FormikWrapper(ProvidersAddressCRUDFormComposition))
