...
import ProvidersProviderCRUDFormComponent from './ProvidersProviderCRUDForm.Component'

class ProvidersProviderCRUDFormComposition extends Component {
    ...
    render() {
        ...
        return(
            <ProvidersProviderCRUDFormComponent
                {...this.props}
